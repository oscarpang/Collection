...
int** expand(int* loc,int rows, int cols);
...
//        cout << "Head " << head << endl;
//        cout << "Tail before the loop" << tail << endl;
//        cout << "Head loc" << queue[head][0] << " " << queue[head][1] << endl; 
...
//            cout << "Number of valid location" << numLocs << endl;
